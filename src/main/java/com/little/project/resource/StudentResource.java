...
public class StudentResource {
    ...
    public ResponseEntity<Student> addCourseToStudent(@PathVariable Long id, @RequestBody Course course){
        Student updatedStudent = service.addCourseToStudent(id, course);
